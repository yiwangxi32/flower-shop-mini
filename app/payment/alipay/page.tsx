  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="sticky top-0 z-10 flex items-center bg-white p-4 shadow-sm">
        ...
        <h1 className="text-lg font-medium">支付宝支付</h1>
      </div>
        ...
        <div className="rounded-lg bg-white p-6 shadow-sm">
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              ...
              <button onClick={copyOrderNumber} className="ml-1 inline-flex items-center text-blue-500">
          ...
          <div className="my-6 flex flex-col items-center">
            <div className="relative mb-4 h-48 w-48 overflow-hidden rounded-lg border-4 border-blue-500 p-2">
              <Image
            ...
            <p className="text-sm text-gray-600">请使用支付宝扫一扫，扫描二维码完成支付</p>
            <p className="mt-2 text-sm text-gray-500">
              二维码有效期：<span className="text-blue-500">{formatCountdown()}</span>
            </p>
          </div>
